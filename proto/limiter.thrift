...
service Limiter {
    ...
    /**
     * Получение актуальных значений изменённых лимитов с учётом
     * операции в запросе. То есть, если эти изменения лимитов в
     * статусе 'холд', то они всё равно учитываются в результате.
     */
